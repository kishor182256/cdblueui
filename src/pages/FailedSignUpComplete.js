import {
  ...
  export default function FailedSignUpComplete() {
          ...
          <Stack  display='flex' justifyContent='center'
            ...
            <Heading
              ...
              fontFamily= "Helvetica, Roboto, Arial, sans-serif">
                 Thank you for registering!            </Heading></Stack>
            <Box   display='flex' justifyContent='center' 
             alignItems='center' width="120%">
            <Text  fontSize='16px' fontWeight='500'
              color="#6f6f6f" ml='-50px'
              lineHeight="1.6"
              fontFamily="Circular-Book,Arial,Helvetica,sans-serif">
    We will let you know as soon as we have approved your account.                            </Text>
          </Box>
          {/* <Box   display='flex' justifyContent='center' 
             alignItems='center'>
              ...
              fontFamily="Circular-Book,Arial,Helvetica,sans-serif">
                   ...
                   able to access your online account straight away            </Text>
             </Box> */}
